...
public:
    ...
    void drawParticles(const std::vector<Particle>& particles);    void drawMesh(const Mesh& mesh, const glm::vec3& position);
    void drawMesh(const Mesh& mesh, const glm::mat4& transformMatrix);
